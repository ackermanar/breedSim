...
gBLUP_pRep <- asreml(fixed = predicted.value ~ 1,
                    ...
                    data = BLUE_pRep, 
                    na.action = na.method(y = "omit", x = "omit"))
saveRDS(gBLUP_pRep, str_c("gBLUP_pRep_amodV", version, ".RData"))
...
gBLUP_RR <- asreml(fixed = predicted.value ~ 1,
                  ...
                  data = BLUE_RR, 
                  na.action = na.method(y = "omit", x = "omit"))
saveRDS(gBLUP_pRep, str_c("gBLUP_RR_amodV", version, ".RData"))
...
gBLUP_RCBD <- asreml(fixed = predicted.value ~ 1,
                  ...
                  data = BLUE_RCBD, 
                  na.action = na.method(y = "omit", x = "omit"))
saveRDS(gBLUP_pRep, str_c("gBLUP_RCBD_amodV", version, ".RData"))
